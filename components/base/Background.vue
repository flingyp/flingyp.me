<template>
  <div
    class="
      -z-10 overflow-hidden fixed w-screen h-screen
      top-0 left-0 right-0 bottom-0
    "
  >
    <!-- small starts -->
    <div>
      <div class="signup-bg-stars w-0.5 h-0.5" />
      <div
        class="signup-bg-stars-2 w-0.5 h-0.5"
      />
      <div class="signup-bg-stars-3 w-0.5 h-0.5" />
    </div>
    ...
    <div class="relative w-full h-full">
      <div
        ...
        blur-3xl left-[30%] top-[4%] transition opacity-30 md:opacity-50
        animate-scale
      "
      />
      ...
      <div
        ...
        blur-3xl right-[10%] top-[18%] transition opacity-30 md:opacity-50
        animate-scale
      "
      />
      ...
      <div
        class="
        absolute w-60 h-60 rounded-full
        bg-gradient-to-r from-blue-500 via-teal-500 to-orange-500
        blur-3xl left-[10%] bottom-[10%] transition opacity-30 md:opacity-50
        animate-scale
      "
      />
      ...
      <div
        ...
        blur-3xl right-[30%] bottom-[10%] transition opacity-30 md:opacity-50
        animate-scale
      "
      />
    </div>
